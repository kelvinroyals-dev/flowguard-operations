...
const CONFIG = Object.freeze({
  ...
  NAV_ACCESS: Object.freeze({
    admin:              ['dashboard','situation','alerts','clients','properties','assets','network','sensors','teams','team-members','field-reports','maintenance','support','forecast','reports','billing','sla','audit','settings'],
    super_admin:        ['dashboard','situation','alerts','clients','properties','assets','network','sensors','teams','team-members','field-reports','maintenance','support','forecast','reports','billing','sla','audit','settings'],
    operations_manager: ['dashboard','situation','alerts','clients','properties','assets','network','sensors','teams','field-reports','maintenance','support','forecast','reports','billing','sla'],
