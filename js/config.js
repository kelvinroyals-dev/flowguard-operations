...
const CONFIG = Object.freeze({
  ...
  NAV_ACCESS: Object.freeze({
    admin:              ['dashboard','situation','alerts','clients','providers','jobs','properties','assets','network','sensors','teams','team-members','field-reports','maintenance','support','forecast','reports','billing','sla','audit','settings'],
    super_admin:        ['dashboard','situation','alerts','clients','providers','jobs','properties','assets','network','sensors','teams','team-members','field-reports','maintenance','support','forecast','reports','billing','sla','audit','settings'],
    operations_manager: ['dashboard','situation','alerts','clients','providers','jobs','properties','assets','network','sensors','teams','field-reports','maintenance','support','forecast','reports','billing','sla'],
    dispatcher:         ['dashboard','situation','alerts','jobs','assets','network','sensors','teams','field-reports','maintenance','support','forecast'],
    field_lead:         ['dashboard','situation','alerts','assets','network','sensors','field-reports','maintenance','forecast'],
