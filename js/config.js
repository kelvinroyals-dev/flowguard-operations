...
const CONFIG = Object.freeze({
  ...
  NAV_ACCESS: Object.freeze({
    admin:              ['dashboard','alerts','clients','properties','teams','team-members','field-reports','reports','billing','sla','audit','settings'],
    super_admin:        ['dashboard','alerts','clients','properties','teams','team-members','field-reports','reports','billing','sla','audit','settings'],
    operations_manager: ['dashboard','alerts','clients','properties','teams','field-reports','reports','billing','sla'],
    dispatcher:         ['dashboard','alerts','teams','field-reports'],
    field_lead:         ['dashboard','alerts','field-reports'],
